...
theme.loadSyntax = function ()
    ...
    local syntax = {
        ...
        Comment             = { fg = colors.comments, italic = config.italics.comments },
        SpecialComment      = { link = "Comment" },
        Conditional         = { fg = colors.purple, italic = config.italics.keywords },
        Constant            = { fg = colors.yellow },
        Character           = { fg = colors.orange },
        Number              = { fg = colors.orange },
        Boolean             = { fg = colors.orange },
        Float               = { fg = colors.orange },
        Function            = { fg = colors.blue, italic = config.italics.functions },
        Identifier          = { fg = colors.fg, italic = config.italics.variables };
        Statement           = { fg = colors.cyan },
        Keyword             = { fg = colors.purple, italic = config.italics.keywords },
        ...
        Repeat              = { fg = colors.purple, italic = config.italics.keywords },
        String              = { fg = colors.green, italic= config.italics.strings },
...
theme.loadTreeSitter = function ()
    ...
    local treesitter = {
        ...
        TSStringEscape =            { fg = colors.fg_alt }, -- For escape characters within a string.
...
theme.loadPlugins = function()
    ...
    if config.plugins.trouble then
        plugins.TroubleText =                           { fg = colors.fg_alt, bg = colors.sidebar }
    ...
    if config.plugins.neogit then
        ...
        plugins.NeogitDiffContextHighlight =            { fg = colors.fg_alt, bg = colors.contrast }
